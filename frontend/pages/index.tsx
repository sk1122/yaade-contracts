...
export default function Home() {
  ...
  //     contract.on(
  //       "BidAdded",
  //       (bidder: string, id: number, bid: number, index: number) => {
  ...
  //     contract.on(
  //       "BidWinner",
  //       (bidder: string, _listingId: number, bid: number, bidId: number) => {
  //         console.log(
  //           "NFT",
  //           bidder,
  //           _listingId.toString(),
  ...
  //     try {
  //       const options = {
  //         value: ethers.utils.parseEther(ethers.utils.formatEther(bidAmount)),
  //       };
